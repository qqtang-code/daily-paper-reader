...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-14 22:10:29 UTC<br>状态：成功</p>
</section>
...
<p>精读：《SAS: Simple Attention Sparsification via End-to-End Optimization of Context Ranking》（9.0/10）, 《Fixed State, Long Reach: What a Constant-Size Cache Buys Block Diffusion at Scale》（8.0/10）</p>
<p>速读：《OneLA: Scaling Linear-Attention Decoding to Large Beams in Generative Recommendation》（7.0/10）, 《Adaptive Anisotropic Attention for Axis-Structured Signals》（6.0/10）, 《Vortex: Bridging Extreme Compression and Efficient LLM Inference》（6.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="SAS: Simple Attention Sparsification via End-to-End Optimization of Context Ranking">SAS: Simple Attention Sparsification via End-to-End Optimization of Context Ranking</span></li><li><span class="dpr-home-dashboard-paper-title" title="Fixed State, Long Reach: What a Constant-Size Cache Buys Block Diffusion at Scale">Fixed State, Long Reach: What a Constant-Size Cache Buys Block Diffusion at Scale</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="OneLA: Scaling Linear-Attention Decoding to Large Beams in Generative Recommendation">OneLA: Scaling Linear-Attention Decoding to Large Beams in Generative Recommendation</span></li><li><span class="dpr-home-dashboard-paper-title" title="Adaptive Anisotropic Attention for Axis-Structured Signals">Adaptive Anisotropic Attention for Axis-Structured Signals</span></li><li><span class="dpr-home-dashboard-paper-title" title="Vortex: Bridging Extreme Compression and Efficient LLM Inference">Vortex: Bridging Extreme Compression and Efficient LLM Inference</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">sparse-attn <strong>6</strong></span></div>
</section>
</div>
